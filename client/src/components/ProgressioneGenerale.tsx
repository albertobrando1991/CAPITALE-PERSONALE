...
export const defaultFasiProgress: FaseProgress[] = [
  {
    id: 1,
    nome: "Intelligence",
    descrizione: "Decodifica bando + Setup",
    percentuale: 0,
    stato: "in_corso",
  },
  {
    id: 0.5,
    nome: "Fondamenta AI",
    descrizione: "Costruzione schema mentale",
    percentuale: 0,
    stato: "bloccata",
  },
  {
    id: 2,
    nome: "Acquisizione",
    descrizione: "Studio analitico preciso",
    percentuale: 0,
    stato: "bloccata",
  },
  {
    id: 3,
    nome: "Consolidamento",
    descrizione: "Memoria a lungo termine",
    percentuale: 0,
    stato: "bloccata",
  },
  {
    id: 4,
    nome: "Drill & Simulazione",
    descrizione: "Automatismo + Gestione stress",
    percentuale: 0,
    stato: "bloccata",
  },
];
