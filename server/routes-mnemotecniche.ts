...
router.get('/numeri', requireAuth, async (req: Request, res: Response) => { 
  try { 
...
router.post('/numeri', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { 
      concorsoId, 
...
router.delete('/numeri/:id', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { id } = req.params; 
...
router.get('/palazzi', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { concorsoId } = req.query; 
...
router.get('/palazzi/:id', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { id } = req.params; 
...
router.post('/palazzi', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { 
      concorsoId, 
...
router.patch('/palazzi/:id', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { id } = req.params; 
...
router.delete('/palazzi/:id', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { id } = req.params; 
...
router.get('/film', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
...
router.get('/film/:id', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { id } = req.params; 
...
router.post('/film', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { 
      concorsoId, 
...
router.patch('/film/:id', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { id } = req.params; 
    const updates = req.body; 
...
router.delete('/film/:id', requireAuth, async (req: Request, res: Response) => { 
  try { 
    const userId = req.user!.id; 
    const { id } = req.params; 
